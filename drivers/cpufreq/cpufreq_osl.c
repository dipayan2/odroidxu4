...
{
	return cpufreq_register_governor(&cpufreq_gov_osl);
}
...
static void __exit cpufreq_gov_dbs_exit(void)
{
	...
	cpufreq_unregister_governor(&cpufreq_gov_osl);
}

MODULE_AUTHOR ("Dipayan");
MODULE_DESCRIPTION ("'cpufreq_osl' - A dynamic cpufreq governor which "
		"minimizes the frequecy jumps steps always selecting either "
		);
MODULE_LICENSE ("GPL");
